...
<ul class="nav nav-tabs">
  <li class="nav-item">
    <a class="nav-link active" style="background-color: #7ffa84;" href="#"><b>ANTRIAN PEMBAYARAN ( <?php echo $jumlah_antrian; ?> )</b></a>
  </li>
  <li class="nav-item">
    <a class="nav-link" style="color: black;" href="transisi_kasir.php?tgl=<?php echo $tgl; ?>"><b>SELESAI PEMBAYARAN ( <?php echo $jumlah_pulang; ?> )</b></a>
  </li>
</ul> 
</nav>
          ...
          <div class="box-body">
            <div class="table-responsive">
              <table class="table table-bordered table-striped" id="table-datatable">
                ...
                if(isset($_GET['tgl'])){
                $tgl= $_GET['tgl'];
                $data = mysqli_query($koneksi,"SELECT * FROM visit WHERE visit_tanggal LIKE '%$tgl%' AND (visit_status='BELUM BAYAR') order by visit_id ASC");
                }else{
                $data = mysqli_query($koneksi,"SELECT * FROM visit WHERE visit_tanggal='$filter' AND (visit_status='BELUM BAYAR') order by visit_id ASC") ;
                    }
