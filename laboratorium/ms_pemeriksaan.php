...
<title>Master Pemeriksaan Non Paket</title>
<div class="content-wrapper">
    
  <section class="content-header">
    <h1>
      PEMERIKSAAN
      <small>Data Non Paket</small>
    </h1>
    <ol class="breadcrumb">
...
<ul class="nav nav-tabs">
  <li class="nav-item">
    <a class="nav-link active" style="color: black;" href="ms_pemeriksaan.php"><b>PEMERIKSAAN NON PAKET</b></a>
  </li>
  <li class="nav-item">
    <a class="nav-link" style="color: green;" href="ms_pemeriksaan_paket.php"><b>PEMERIKSAAN PAKET</b></a>
  </li>
            ...
            <div class="table-responsive col-lg-12">
                ...
                <tbody>
                  ...
                  $no=1;
                    ...
                    $filter= $_GET['filter'];                  
                    $data = mysqli_query($koneksi,"SELECT * FROM ms_pemeriksaan,ms_klasifikasi where klasifikasi_id=klasifikasi_pemeriksaan AND klasifikasi_pemeriksaan='$filter' AND status='tidak' order by kode_urutan ASC");
                    }else{
                    $data = mysqli_query($koneksi,"SELECT * FROM ms_pemeriksaan,ms_klasifikasi where klasifikasi_id=klasifikasi_pemeriksaan AND status='tidak' order by kode_urutan ASC");
                    }
