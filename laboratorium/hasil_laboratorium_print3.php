...
<!--header-->
            <table width="1000" border="0" align="center">
              <tr>
                ...
                <td width="661"><div align="center"><span class="style1">&nbsp;<br/>
...
<!--<hr align="center" width="1000" size="3" color="green"/>-->
            ...
            <table class=table2 width="1000" border="0" align="center">
                    <?php
...
<!-- HASIL PEMERIKSAAN -->
            ...
            <table class=table1 width="1000" border=1 align="center">
              <tr bgcolor="#c6c9c5">
                <th class=th1 width="272" scope="col">PEMERIKSAAN</th>
                <th class=th1 width="427" scope="col">HASIL</th>
                <th class=th1 width="139" scope="col">SATUAN </th>
                <th class=th1 width="279" scope="col">NILAI RUJUKAN </th>
              </tr>
            <?php
            $no=1;
            ...
            ?> 
              <tr>
                ...
                <td class=td1><center><?php echo $h['hasil_isi']; ?></center></td>
                <td class=td1>&nbsp <?php echo $h['hasil_satuan']; ?></td>
                <td class=td1>&nbsp <?php echo $h['hasil_nilainormal']; ?></td>
              </tr>
              <?php } ?>
            </table>
